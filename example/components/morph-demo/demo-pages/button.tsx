    ...
    <DemoPageLayout
      ...
      preview={
        <PressableScale
          ...
          style={{ alignSelf: "center", minHeight: state.fontSize * 1.42, borderRadius: 36, backgroundColor: "#007aff", paddingHorizontal: state.fontSize * 0.72, paddingVertical: state.fontSize * 0.22, alignItems: "center", justifyContent: "center" }}
        >
          <Laminar
            ...
            clipToBounds={false}
            style={{ color: "#ffffff", fontFamily: "Sf-semibold", fontSize: 32 }}
          />
        </PressableScale>
      }
      settings={
        <>
          {settingsRow({ label: "Button Text", value: state.buttonWord, onPress: state.cycleButtonWord })}
